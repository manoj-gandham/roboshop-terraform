...
module "rds" {
  source = "git::https://github.com/manoj-gandham/tf-module-rds.git"
...
module "elasticache" {
  source = "git::https://github.com/manoj-gandham/tf-module-elasticache.git"
...
module "alb" {
  source = "git::https://github.com/manoj-gandham/tf-module-alb.git"
